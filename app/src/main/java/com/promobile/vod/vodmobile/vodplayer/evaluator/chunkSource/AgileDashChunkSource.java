 ...
 */
public class AgileDashChunkSource implements ChunkSource {
   ...
   */
  public AgileDashChunkSource(DataSource dataSource, FormatEvaluator formatEvaluator,
   ...
   * @param formatEvaluator Selects from the available formats.
   */
  public AgileDashChunkSource(MediaPresentationDescription manifest, int adaptationSetIndex,
   ...
   */
  public AgileDashChunkSource(ManifestFetcher<MediaPresentationDescription> manifestFetcher,
  ...
  private AgileDashChunkSource(ManifestFetcher<MediaPresentationDescription> manifestFetcher,
  ...
  public void continueBuffering(long playbackPositionUs) {
    ...
    if (currentManifest != newManifest && newManifest != null) {
      Representation[] newRepresentations = AgileDashChunkSource.getFilteredRepresentations(newManifest,
              adaptationSetIndex, representationIndices);
  ...
  public final void getChunkOperation(List<? extends MediaChunk> queue, long seekPositionUs,
    ...
    if(bufferTime > AgileEvaluator.L_BUFFER_MAX) {
    ...
    /**
     * Código original DashChunkSource
     */
