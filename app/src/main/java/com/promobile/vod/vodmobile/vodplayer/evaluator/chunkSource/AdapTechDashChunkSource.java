 ...
 */
public class AdapTechDashChunkSource implements ChunkSource {
   ...
   */
  public AdapTechDashChunkSource(DataSource dataSource, FormatEvaluator formatEvaluator,
   ...
   * @param formatEvaluator Selects from the available formats.
   */
  public AdapTechDashChunkSource(MediaPresentationDescription manifest, int adaptationSetIndex,
   ...
   */
  public AdapTechDashChunkSource(ManifestFetcher<MediaPresentationDescription> manifestFetcher,
  ...
  private AdapTechDashChunkSource(ManifestFetcher<MediaPresentationDescription> manifestFetcher,
  ...
  public void continueBuffering(long playbackPositionUs) {
    ...
    if (currentManifest != newManifest && newManifest != null) {
      Representation[] newRepresentations = AdapTechDashChunkSource.getFilteredRepresentations(newManifest,
              adaptationSetIndex, representationIndices);
